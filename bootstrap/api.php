...
$container->singleton(EncryptionService::class, fn () => new EncryptionService());
...
// API-Subdomain: CORS + Rate-Limiting + Logging, kein SecurityHeadersMiddleware (Web-Kontext)
$kernel->setGlobal([
