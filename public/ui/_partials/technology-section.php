...
<section class="py-20" data-fg-d3bl187="0.8:1.32440:/src/app/App.tsx:595:7:23868:1686:e:section:e"
    data-fgid-d3bl187=":r6f:" style="background: var(--card); border-top: 1px solid rgba(0, 200, 255, 0.08);">
        ...
        <div class="flex flex-wrap justify-center gap-3"
            ...
            <?php foreach ($items as $item): ?>
                <span class="px-4 py-2 rounded text-sm border transition-all duration-200 cursor-default"
                    ...
                    style="color: var(--muted-foreground); border-color: var(--border); background: color-mix(in srgb, var(--muted) 30%, transparent); font-family: &quot;JetBrains Mono&quot;, monospace;"><?= htmlspecialchars($item, ENT_QUOTES, 'UTF-8') ?></span>
            <?php endforeach; ?>
        </div>
    </div>
</section>