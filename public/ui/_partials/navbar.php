...
$renderNavItems = static function (array $items): string {
    ...
    foreach ($items as $item) {
        ...
        if (is_array($children) && $children !== []) {
            ...
            $html .= '<button class="gb-submenu-toggle inline-flex w-full items-center justify-between gap-2 rounded-lg px-3 py-2 text-left text-sm font-normal text-[#5a7494] transition-colors duration-200 hover:text-[#e8edf5] focus-visible:text-[#e8edf5] focus-visible:outline-none md:w-auto md:justify-start md:px-0 md:py-0" type="button" aria-expanded="false">';
            ...
            $html .= '</button>';
            $html .= '<ul class="gb-submenu hidden space-y-1 pl-3 md:absolute md:left-0 md:top-full md:z-30 md:mt-3 md:min-w-56 md:space-y-0 md:rounded-xl md:border md:border-[#00c8ff]/25 md:bg-[#0c1520]/95 md:p-2 md:pl-2 md:backdrop-blur-md md:shadow-2xl" role="menu">';
            ...
            foreach ($children as $child) {
                ...
                $html .= '<li role="none"><a href="' . $childHref . '" class="block rounded-lg px-3 py-2 text-sm text-[#5a7494] transition-colors duration-200 hover:bg-[#00c8ff]/10 hover:text-[#e8edf5] focus-visible:bg-[#00c8ff]/10 focus-visible:text-[#e8edf5] focus-visible:outline-none" role="menuitem">' . $childLabel . '</a></li>';
            }
        ...
        $html .= '<li><a href="' . $href . '" class="block rounded-lg px-3 py-2 text-sm font-normal text-[#5a7494] transition-colors duration-200 hover:text-[#e8edf5] focus-visible:text-[#e8edf5] focus-visible:outline-none md:px-0 md:py-0">' . $label . '</a></li>';
    }
...
<header class="fixed top-0 left-0 right-0 z-50 transition-all duration-300"
    ...
    style="background: rgba(6, 10, 15, 0.92); backdrop-filter: blur(16px); border-bottom: 1px solid rgba(0, 200, 255, 0.1);">
    <div class="relative max-w-7xl mx-auto px-6 h-16 flex items-center justify-between"
        ...
        <a href="/" class="flex items-center gap-2"
            data-fg-d3bl14="0.8:1.32440:/src/app/App.tsx:178:11:6104:397:e:div:ete" data-fgid-d3bl14=":r3:"><svg
                ...
                style="font-family: &quot;JetBrains Mono&quot;, monospace; color: rgb(232, 237, 245);"><?= $note; ?><span
                    ...
                    style="color: rgb(0, 200, 255);">.com</span></span></a>
        <nav class="gb-nav absolute left-4 right-4 top-[4.5rem] hidden rounded-2xl border border-[#00c8ff]/20 bg-[#0c1520]/95 p-4 backdrop-blur-md shadow-2xl md:static md:block md:rounded-none md:border-0 md:bg-transparent md:p-0 md:shadow-none"
        ...
        <div class="hidden md:flex items-center gap-3"
            data-fg-d3bl24="0.8:1.32440:/src/app/App.tsx:203:11:7084:1386:e:div:ete" data-fgid-d3bl24=":rd:"><button
                ...
                style="color: rgb(0, 200, 255); border-color: rgba(0, 200, 255, 0.3); background: transparent; font-family: &quot;JetBrains Mono&quot;, monospace;"
                ...
                style="background: rgb(0, 200, 255); color: rgb(6, 10, 15); font-family: &quot;JetBrains Mono&quot;, monospace;"
            ...
            style="color: rgb(232, 237, 245);"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
