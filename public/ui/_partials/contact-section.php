...
<section class="relative py-32 overflow-hidden"
    ...
    <div class="relative z-10 max-w-4xl mx-auto px-6 text-center"
        ...
        <p class="text-lg mb-12 max-w-xl mx-auto" data-fg-d3bl236="0.8:1.32440:/src/app/App.tsx:722:11:29058:186:e:p:t"
            data-fgid-d3bl236=":r8o:" style="color: var(--muted-foreground);"><?=$subtitle ?></p>
        <div class="flex flex-col sm:flex-row gap-4 justify-center"
            data-fg-d3bl238="0.8:1.32440:/src/app/App.tsx:725:11:29255:1719:e:div:ete" data-fgid-d3bl238=":r8p:"><button
                ...
                style="background: var(--primary); color: var(--primary-foreground); font-family: &quot;JetBrains Mono&quot;, monospace;" onclick="window.location.href='<?=$cta1['url'] ?>'"><?=$cta1['text'] ?><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                ...
                style="color: var(--foreground); border-color: var(--border); font-family: &quot;JetBrains Mono&quot;, monospace;" onclick="window.location.href='<?=$cta2['url'] ?>'"><?=$cta2['text'] ?></button></div>
    </div>
</section>